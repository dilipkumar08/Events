...
function onMessage(event) {
  ...
  var widgets = [{
    textParagraph: {
      text: 'Hello, ' + name + '.Are you taking time off today?'
    }
  }, {
    buttons: [{
      textButton: {
...
function turnOnAutoResponder(reason) {
  ...
  Gmail.Users.Settings.updateVacation({
    ...
    responseBodyHtml: "I'm out of the office today; will be back on the next business day.<i>Created by Attendance Bot!</i>",
